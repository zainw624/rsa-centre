    ...
    <main className="main-shell px-6 py-10">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-10">
        ...
        <section className="card rounded-3xl p-10 text-center">
          ...
          <Link href="/login" className="mt-10 inline-flex items-center justify-center rounded-full px-8 py-4 text-sm font-semibold uppercase tracking-[0.2em] text-rsa-gold transition hover:bg-rsa-gold/10" style={{ border: '1px solid var(--rsa-gold)' }}>
            Return to login
          </Link>
        </section>
      </div>
